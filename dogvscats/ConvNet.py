...
class ConvolutionNet:
    ...
    def create_network(self):
        ...
        model.add(Convolution2D(32, 3, 3, border_mode='same', input_shape=self._input_dim))
        ...
        model.compile(loss=self._loss_function, optimizer=optimizer, metrics=self._metrics)
        self._model = model
